...
?>
	<div style="width:80%;height:95px;background-color:#6D214F;position:absolute;border-top-left-radius:35px;border-top-right-radius:35px;margin-left:10%;margin-top:200px">
		...
		<font style="font-size:50px;color:white;margin-left:100px;font-family:'Times New Roman';">Öğrenci Yazdır</font></div>
    ...
    <form action="" method="Post" enctype="multipart/form-data">
        ...
        <tr>
           ...
           <option value="seçim yapılmadı" selected>Lütfen Seçiniz</option>
                ...
                <td><a class="onizle"href="yazdırbelge2.php?pid=<?=$gonderdi?>">Önizleme</a></td>
                </tr> 
